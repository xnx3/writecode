...
public class Test {
	public static void main(String[] args) {
		...
		//指定生成模板为wm框架的实体类
		Template template = new GenerateCacheTemplate();
		template.setTemplateFileAbsolutePath("{project.path.absolute}/src/main/java/com/xnx3/writecode/template/wm/generateCache/");
		template.setTemplateFileName("template");
		template.setWriteFileAbsolutePath("{project.path.absolute}/src/main/java/com/xnx3/writecode/template/wm/generateCache/");
		template.setWriteFileName("js.txt");
