...
public class Test {
	public static void main(String[] args) {
		...
		template.setTemplateFileAbsolutePath("{project.path.absolute}/src/main/java/com/xnx3/writecode/template/wm/entity/");
		template.setTemplateFileName("template");
		template.setWriteFileAbsolutePath("{project.path.absolute}/src/main/java/com/xnx3/writecode/template/wm/entity/");
		template.setWriteFileName("entity.txt");
