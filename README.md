## 自动写代码
根据数据表，自动写出代码（实体类、vo类、controller、前端页面、接口文档）。而你只需右键-运行，鼠标点几下选择，就全部自动写出代码。  
曾思考过，为了少写代码、提高效率，而花时间去学习某款框架，这一来一回，是否真的值得？而且框架更新换代这么快，学了一个又一个... **而我们最初的想法是将写代码的时间减少，效率更高，减少加班，使生活更好**，无需投入精力学习它，拿来直接使用，才是我们需要的。  
